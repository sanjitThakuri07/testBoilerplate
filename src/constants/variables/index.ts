...
export const PrivateRoute = {
  ...
  ORGCONFIG: {
    ...
    BOOKING: {
      LINK: "booking-status",
      ADD: "booking-status/add",
      EDIT: "booking-status/edit/:bookingStatusId",
      VIEW: "booking-status/view/:bookingStatusId",
      CHILD_LINKS: {
        BOOKING_STATUS: {
          HOME: "booking-status",
          ADD: "/config/booking-status/add",
          EDIT: "/config/booking-status/edit/:bookingStatusId",
          VIEW: "/config/booking-status/view/:bookingStatusId",
        },
      },
    },
