...
import EditView from "./ViewEdit";
import { permissionList } from "src/constants/permission";

const ViewAssignActivity = () => {
  ...
  const breadcrumbs = [
    ...
    <Typography key="2" color="text.primary">
      {assignActivityId && !readOnly ? "Edit" : readOnly ? "View" : "Add"}
    </Typography>,
  ];
      ...
      {!loading && (
        <div className="add-region-config-holder position-relative">
          <div className="header-block">
            ...
            <EditView permission={Activity.edit} />
...
export default ViewAssignActivity;
