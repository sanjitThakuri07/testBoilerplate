...
const ContractorAddress: React.FC<{
  ...
  console.log(cityData, "coityskad");
                                  ...
                                  <Grid container spacing={4} className="formGroupItem">
                                    ...
                                    <Grid item xs={6}>
                                      <Select
                                        ...
                                        disabled={disabled}
                                        autoComplete="off"
                                        // disabled={!values?.address[`${index}`]?.territory}
                                        // className={
                                        //   !values?.address[`${index}`]?.territory ? 'disabled' : ''
                                        // }
                                        value={
                                          (values?.address[`${index}`] &&
                                  ...
                                  {/* <Grid container spacing={4} className="formGroupItem">
                                    <Grid item xs={4}>
                                      <InputLabel htmlFor={`address.${index}.territory`}>
                                        <div className="label-heading  align__label">Territory</div>
                                      </InputLabel>
                                    </Grid>
