...
import { useOrganizationUserStore } from "store/users/organizationUserStore";
import { useUserRoleStore } from "store/users/userRoleStore";
      ...
      >
        <AccessForm
          ...
          onCreate={async ({ values, userRoles }: any) => {
            if (await postTemplateAccess({ values, userRoles })) {
              handleModalClose();
            }
          }}
      ...
      <div id="AccessControl">
        ...
        <div className="access_control_container">
          <div className="access_control__wrapper">
            <div className="title">{templateAccess?.items?.[0]?.template}</div>
            ...
            <div className="row">
              ...
              {templateAccess?.items?.map((ar: any) => (
                <div className="column_wrapper">
                  <div className="column">
                    <div>
                      {ar?.owner ? (
                  ...
                  <div className="column">
                    <div className="actions">
                      ...
                      {ar.id === templateAccess?.items?.[0]?.id ? null : (
